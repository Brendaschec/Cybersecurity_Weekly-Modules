...
In this module, we will use the local Vagrant virtual machine. You will log in using the following credentials:
...
You can access this module's Challenge assignment here: 

- [Module Challenge File](./homework/Readme.md)
